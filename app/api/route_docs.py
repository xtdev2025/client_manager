            ...
            "responses": {
                "200": {
                    ...
                    "content": {
                        ...
                        "application/json": {"schema": {"$ref": "#/components/schemas/DashboardStatsSchema"}}
                    }
                },
                "401": {
...
def document_auth_routes(spec: APISpec) -> None:
    ...
    # GET/POST /auth/login
    add_path(spec, "/auth/login", {
        "get": {
            "tags": ["Auth"],
            "summary": "Display login page",
            "description": "Renders the login page. Redirects to home if already authenticated.",
            "responses": {
                "200": {"description": "Login page rendered successfully", "content": {"text/html": {"schema": {"type": "string"}}}},
    ...
    add_path(spec, "/auth/register", {
        ...
        "post": {
                    ...
                    "application/x-www-form-urlencoded": {
                        "schema": {
                            ...
                            "properties": {
                                ...
                                "confirm_password": {"type": "string", "minLength": 6, "format": "password"}
                            },
            ...
            "responses": {
                ...
                "400": {"description": "Bad request - Validation error", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/ValidationError"}}}}
            }
        }
    })
    
    # GET/POST /auth/register_admin
    add_path(spec, "/auth/register_admin", {
        "get": {
            "tags": ["Auth"],
...
def document_client_routes(spec: APISpec) -> None:
        ...
        "get": {
            ...
            "responses": {
                "200": {
                    ...
                    "content": {
                        "text/html": {"schema": {"type": "string"}},
                        "application/json": {"schema": {"$ref": "#/components/schemas/ClientListResponse"}}
                    }
                },
                "401": {"description": "Unauthorized"},
                    ...
                    "application/x-www-form-urlencoded": {
                        "schema": {
                            ...
                            "properties": {
                                "username": {"type": "string", "minLength": 3},
                                "password": {"type": "string", "minLength": 6, "format": "password"},
                                "plan_id": {"type": "string", "description": "MongoDB ObjectId of plan"},
                                "template_id": {"type": "string", "description": "MongoDB ObjectId of template"},
                                "status": {"type": "string", "enum": ["active", "inactive"], "default": "active"},
                                "plan_activation_date": {"type": "string", "format": "date", "description": "Plan activation date (YYYY-MM-DD)"},
                                "plan_expiration_date": {"type": "string", "format": "date", "description": "Plan expiration date (YYYY-MM-DD)"}
                            },
                            "required": ["username", "password"]
                        }
                    }
    ...
    add_path(spec, "/clients/edit/{client_id}", {
        "get": {
            "tags": ["Clients"],
            ...
            "security": [{"session_auth": []}],
            "parameters": [
                {"name": "client_id", "in": "path", "required": True, "schema": {"type": "string"}, "description": "Client MongoDB ObjectId"}
            ],
            "responses": {
                "200": {"description": "Form rendered successfully"},
                    ...
                    "application/x-www-form-urlencoded": {
                        "schema": {
                            ...
                            "properties": {
                                ...
                                "password": {"type": "string", "format": "password", "description": "Leave empty to keep current"},
                                "plan_id": {"type": "string"},
    ...
    add_path(spec, "/clients/delete/{client_id}", {
        "post": {
            "tags": ["Clients"],
    ...
    add_path(spec, "/clients/view/{client_id}", {
        "get": {
            "tags": ["Clients"],
            ...
            "responses": {
                "200": {
                    ...
                    "content": {
                        "text/html": {"schema": {"type": "string"}},
                        "application/json": {"schema": {"$ref": "#/components/schemas/ClientSchema"}}
                    }
                },
                "404": {"description": "Client not found"},
                "401": {"description": "Unauthorized"},
    ...
    add_path(spec, "/clients/{client_id}/domains", {
        "get": {
            "tags": ["Clients"],
            ...
            "responses": {
                "200": {
                    ...
                    "content": {"application/json": {"schema": {"$ref": "#/components/schemas/DomainListResponse"}}}
                },
                "404": {"description": "Client not found"},
                "401": {"description": "Unauthorized"},
                "403": {"description": "Forbidden"}
    ...
    add_path(spec, "/clients/{client_id}/domains/add", {
        "post": {
            "tags": ["Clients"],
                ...
                "content": {
                    "application/x-www-form-urlencoded": {
                        "schema": {
                            "type": "object",
                            "properties": {
                                "domain_id": {"type": "string", "description": "Domain MongoDB ObjectId to associate"}
                            },
                            "required": ["domain_id"]
                        }
                    }
    ...
    add_path(spec, "/clients/{client_id}/domains/remove/{client_domain_id}", {
        "post": {
            "tags": ["Clients"],
            ...
            "parameters": [
                {"name": "client_id", "in": "path", "required": True, "schema": {"type": "string"}},
                {"name": "client_domain_id", "in": "path", "required": True, "schema": {"type": "string"}}
            ],
            "responses": {
...
def document_client_portal_routes(spec: APISpec) -> None:
    ...
    add_path(spec, "/client/my-domains", {
        "get": {
            "tags": ["Client Portal"],
            ...
            "security": [{"session_auth": []}],
            "responses": {
                "200": {"description": "Domains retrieved successfully", "content": {"text/html": {"schema": {"type": "string"}}}},
                "401": {"description": "Unauthorized"},
    ...
    add_path(spec, "/client/my-click-stats", {
        "get": {
            "tags": ["Client Portal"],
    ...
    add_path(spec, "/client/my-change-password", {
        "get": {
            "tags": ["Client Portal"],
                    ...
                    "application/x-www-form-urlencoded": {
                        "schema": {
                            ...
                            "properties": {
                                ...
                                "new_password": {"type": "string", "minLength": 6, "format": "password"},
                                "confirm_password": {"type": "string", "minLength": 6, "format": "password"}
                            },
...
def document_admin_routes(spec: APISpec) -> None:
    ...
    add_path(spec, "/admins/", {
        "get": {
            ...
            "security": [{"session_auth": []}],
            "responses": {
                "200": {"description": "Admins retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/AdminListResponse"}}}},
                "401": {"description": "Unauthorized"},
                "403": {"description": "Forbidden"}
            }
        }
    ...
    add_path(spec, "/admins/edit/{admin_id}", {
        "get": {
            "tags": ["Admins"],
            "summary": "Display admin edit form",
            "description": "Renders admin edit form. Super admin only.",
            "security": [{"session_auth": []}],
            "parameters": [{"name": "admin_id", "in": "path", "required": True, "schema": {"type": "string"}}],
            "responses": {
                "200": {"description": "Form rendered"},
    ...
    add_path(spec, "/admins/delete/{admin_id}", {
        "post": {
            "tags": ["Admins"],
    ...
    add_path(spec, "/admins/audit-logs", {
        "get": {
            "tags": ["Audit"],
            ...
            "security": [{"session_auth": []}],
            "responses": {
                "200": {"description": "Logs retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/AuditLogListResponse"}}}},
                "401": {"description": "Unauthorized"},
                "403": {"description": "Forbidden"}
            }
        }
    ...
    add_path(spec, "/admins/clear-audit-logs", {
        "post": {
            "tags": ["Audit"],
...
def document_plan_routes(spec: APISpec) -> None:
    ...
    add_path(spec, "/plans/", {
        "get": {
            ...
            "security": [{"session_auth": []}],
            "responses": {
                "200": {"description": "Plans retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/PlanListResponse"}}}},
                "401": {"description": "Unauthorized"},
                "403": {"description": "Forbidden"}
            }
        }
    ...
    add_path(spec, "/plans/edit/{plan_id}", {
        "get": {
            "tags": ["Plans"],
    ...
    add_path(spec, "/plans/delete/{plan_id}", {
        "post": {
            "tags": ["Plans"],
            "summary": "Delete plan",
    ...
    add_path(spec, "/plans/view/{plan_id}", {
        "get": {
            "tags": ["Plans"],
            ...
            "parameters": [{"name": "plan_id", "in": "path", "required": True, "schema": {"type": "string"}}],
            "responses": {
                "200": {"description": "Plan details retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/PlanSchema"}}}},
                "404": {"description": "Plan not found"},
                "401": {"description": "Unauthorized"},
                "403": {"description": "Forbidden"}
            }
...
def document_domain_routes(spec: APISpec) -> None:
    ...
    for route in ["/domains/", "/domains/create", "/domains/edit/{domain_id}", "/domains/delete/{domain_id}", "/domains/view/{domain_id}"]:
        if route == "/domains/":
            add_path(spec, route, {
                "get": {
                    "tags": ["Domains"],
                    ...
                    "security": [{"session_auth": []}],
                    "responses": {
                        "200": {"description": "Domains retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/DomainListResponse"}}}},
                        "401": {"description": "Unauthorized"},
                        "403": {"description": "Forbidden"}
                    }
                }
            ...
            add_path(spec, route, {
                "get": {"tags": ["Domains"], "summary": "Display domain creation form", "security": [{"session_auth": []}], "responses": {"200": {"description": "Form rendered"}}},
                "post": {
                    "tags": ["Domains"],
                            ...
                            "application/x-www-form-urlencoded": {
                                "schema": {
                                    ...
                                    "properties": {
                                        ...
                                        "cloudflare_email": {"type": "string", "format": "email"},
                    ...
                    "responses": {"302": {"description": "Domain created"}, "401": {"description": "Unauthorized"}, "403": {"description": "Forbidden"}}
                }
            })
        elif "/edit/" in route:
            add_path(spec, route, {
                "get": {"tags": ["Domains"], "summary": "Display domain edit form", "security": [{"session_auth": []}], "parameters": [{"name": "domain_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Form rendered"}, "404": {"description": "Not found"}}},
                "post": {"tags": ["Domains"], "summary": "Update domain", "security": [{"session_auth": []}], "parameters": [{"name": "domain_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"302": {"description": "Updated"}, "404": {"description": "Not found"}}}
            })
        elif "/delete/" in route:
            add_path(spec, route, {"post": {"tags": ["Domains"], "summary": "Delete domain", "security": [{"session_auth": []}], "parameters": [{"name": "domain_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"302": {"description": "Deleted"}, "404": {"description": "Not found"}}}})
        elif "/view/" in route:
            add_path(spec, route, {"get": {"tags": ["Domains"], "summary": "View domain details", "security": [{"session_auth": []}], "parameters": [{"name": "domain_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Details retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/DomainSchema"}}}}, "404": {"description": "Not found"}}}})


def document_template_routes(spec: APISpec) -> None:
    """Document template management routes."""
    
    for route in ["/templates/", "/templates/create", "/templates/edit/{template_id}", "/templates/delete/{template_id}", "/templates/view/{template_id}"]:
        if route == "/templates/":
            add_path(spec, route, {"get": {"tags": ["Templates"], "summary": "List all templates", "security": [{"session_auth": []}], "responses": {"200": {"description": "Templates retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/TemplateListResponse"}}}}}}})
        elif route == "/templates/create":
            add_path(spec, route, {
                "get": {"tags": ["Templates"], "summary": "Display template creation form", "security": [{"session_auth": []}], "responses": {"200": {"description": "Form rendered"}}},
                "post": {"tags": ["Templates"], "summary": "Create new template", "security": [{"session_auth": []}], "responses": {"302": {"description": "Template created"}}}
            })
        elif "/edit/" in route:
            add_path(spec, route, {
                "get": {"tags": ["Templates"], "summary": "Display template edit form", "security": [{"session_auth": []}], "parameters": [{"name": "template_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Form rendered"}}},
                "post": {"tags": ["Templates"], "summary": "Update template", "security": [{"session_auth": []}], "parameters": [{"name": "template_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"302": {"description": "Updated"}}}
            })
        elif "/delete/" in route:
            add_path(spec, route, {"post": {"tags": ["Templates"], "summary": "Delete template", "security": [{"session_auth": []}], "parameters": [{"name": "template_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"302": {"description": "Deleted"}}}})
        elif "/view/" in route:
            add_path(spec, route, {"get": {"tags": ["Templates"], "summary": "View template details", "security": [{"session_auth": []}], "parameters": [{"name": "template_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Details retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/TemplateSchema"}}}}}}})


def document_info_routes(spec: APISpec) -> None:
    """Document banking information management routes."""
    
    add_path(spec, "/infos/", {"get": {"tags": ["Infos"], "summary": "List all banking information", "security": [{"session_auth": []}], "responses": {"200": {"description": "Infos retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/InfoListResponse"}}}}}}})
    add_path(spec, "/infos/client/{client_id}", {"get": {"tags": ["Infos"], "summary": "Get banking info by client", "security": [{"session_auth": []}], "parameters": [{"name": "client_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Infos retrieved"}}}})
    add_path(spec, "/infos/create/{client_id}", {
        "get": {"tags": ["Infos"], "summary": "Display info creation form", "security": [{"session_auth": []}], "parameters": [{"name": "client_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Form rendered"}}},
        "post": {
            "tags": ["Infos"],
    ...
    add_path(spec, "/infos/edit/{info_id}", {
        "get": {"tags": ["Infos"], "summary": "Display info edit form", "security": [{"session_auth": []}], "parameters": [{"name": "info_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Form rendered"}}},
        "post": {"tags": ["Infos"], "summary": "Update banking info", "security": [{"session_auth": []}], "parameters": [{"name": "info_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"302": {"description": "Updated"}}}
    })
    add_path(spec, "/infos/view/{info_id}", {"get": {"tags": ["Infos"], "summary": "View banking info details", "security": [{"session_auth": []}], "parameters": [{"name": "info_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Details retrieved", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/InfoSchema"}}}}}}})
    add_path(spec, "/infos/delete/{info_id}", {"post": {"tags": ["Infos"], "summary": "Delete banking info", "security": [{"session_auth": []}], "parameters": [{"name": "info_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"302": {"description": "Deleted"}}}})
