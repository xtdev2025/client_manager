...
class ClientSchema(UserSchema):
    ...
    plan_activated_at: Optional[datetime] = Field(
        None, description="Plan activation date", alias="planActivatedAt"
    )
    expired_at: Optional[datetime] = Field(
        None, description="Plan expiration date", alias="expiredAt"
    )
