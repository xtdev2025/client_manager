...
class AuditService:
    ...
    def log_admin_action(
        action: str, admin_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        return AuditService.log_action(
            action=action, entity_type="admin", entity_id=admin_id, details=details
        )

    @staticmethod
    def log_client_action(
        action: str, client_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        """
        return AuditService.log_action(
            action=action, entity_type="client", entity_id=client_id, details=details
        )

    @staticmethod
    def log_plan_action(
        action: str, plan_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        """
        return AuditService.log_action(
            action=action, entity_type="plan", entity_id=plan_id, details=details
        )

    @staticmethod
    def log_domain_action(
        action: str, domain_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        """
        return AuditService.log_action(
            action=action, entity_type="domain", entity_id=domain_id, details=details
        )

    @staticmethod
    def log_template_action(
        action: str, template_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        """
        return AuditService.log_action(
            action=action, entity_type="template", entity_id=template_id, details=details
        )

    @staticmethod
    def log_info_action(
        action: str, info_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        """
        return AuditService.log_action(
            action=action, entity_type="info", entity_id=info_id, details=details
        )
    ...
    def get_recent_logs(
        ...
        try:
            ...
            logs = mongo.db.audit_logs.find(query).sort("timestamp", -1).skip(skip).limit(limit)
