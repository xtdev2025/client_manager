...
class AuthView(BaseView):
    ...
    def render_login(form_data=None, errors=None):
        ...
        """
        return BaseView.render("auth/login.html", form_data=form_data, errors=errors)
    ...
    def render_register(form_data=None, errors=None):
        ...
        """
        return BaseView.render("auth/register.html", form_data=form_data, errors=errors)
    ...
    def render_register_admin(form_data=None, errors=None):
        ...
        """
        return BaseView.render("auth/register_admin.html", form_data=form_data, errors=errors)
